...
},{"es5-ext/object/copy":16,"es5-ext/object/map":24,"es5-ext/object/valid-callable":30,"es5-ext/object/valid-value":31}],3:[function(require,module,exports){
'use strict';
...
},{"es5-ext/object/assign":13,"es5-ext/object/is-callable":19,"es5-ext/object/normalize-options":25,"es5-ext/string/#/contains":32}],4:[function(require,module,exports){
...
},{"./":39,"d":3,"es5-ext/object/set-prototype-of":27,"es5-ext/string/#/contains":32}],37:[function(require,module,exports){
'use strict';
...
},{"./array":36,"./string":41,"./valid-iterable":42,"es5-ext/function/is-arguments":6,"es5-ext/string/is-string":35,"es6-symbol":50}],39:[function(require,module,exports){
'use strict';
...
},{"d":3,"d/auto-bind":2,"es5-ext/array/#/clear":4,"es5-ext/object/assign":13,"es5-ext/object/valid-callable":30,"es5-ext/object/valid-value":31,"es6-symbol":50}],40:[function(require,module,exports){
'use strict';
...
},{"es5-ext/function/is-arguments":6,"es5-ext/string/is-string":35,"es6-symbol":50}],41:[function(require,module,exports){
...
},{"./":39,"d":3,"es5-ext/object/set-prototype-of":27}],42:[function(require,module,exports){
'use strict';
...
},{"./iterator-kinds":46,"d":3,"es5-ext/object/set-prototype-of":27,"es6-iterator":39,"es6-symbol":50}],48:[function(require,module,exports){
'use strict';
...
},{"./is-native-implemented":45,"./lib/iterator":47,"d":3,"es5-ext/array/#/clear":4,"es5-ext/array/#/e-index-of":5,"es5-ext/object/set-prototype-of":27,"es5-ext/object/valid-callable":30,"es5-ext/object/valid-value":31,"es6-iterator/for-of":37,"es6-iterator/valid-iterable":42,"es6-symbol":50,"event-emitter":55}],49:[function(require,module,exports){
...
},{"./validate-symbol":54,"d":3}],54:[function(require,module,exports){
'use strict';
...
},{"d":3,"es5-ext/object/valid-callable":30}],56:[function(require,module,exports){
/*!
...
},{"./reactive-map":61,"./utils":62,"es6-map":43,"es6-promise":49,"es6-symbol":50}],59:[function(require,module,exports){
"use strict";
...
},{"./application":58,"./module":60,"./reactive-map":61,"./utils":62}],60:[function(require,module,exports){
"use strict";
...
},{"es6-symbol":50}],61:[function(require,module,exports){
"use strict";
...
},{"./utils":62,"es6-map":43,"es6-symbol":50}],62:[function(require,module,exports){
"use strict";
...
},{"es6-promise":49}],63:[function(require,module,exports){
"use strict";
...
var _sortable = require("./modules/sortable");
...
/* Services
 ----------------------------------------------------------*/
app.use("cookie", _cookie2.default);

/* Register modules
 ----------------------------------------------------------*/
app.use(_menu2.default);
app.use("notifications", _notifications2.default);
app.use("modals", _modal2.default);
app.use(_sortable2.default);

},{"./modules/menu":64,"./modules/modal":65,"./modules/notifications":66,"./modules/sortable":67,"./services/cookie":68,"wrapper6":59}],64:[function(require,module,exports){
"use strict";
...
var MenuModule = function (_Module) {
    _inherits(MenuModule, _Module);

    function MenuModule() {
        _classCallCheck(this, MenuModule);

        return _possibleConstructorReturn(this, (MenuModule.__proto__ || Object.getPrototypeOf(MenuModule)).apply(this, arguments));
    }
    ...
    _createClass(MenuModule, [{
        ...
        value: function boot(app) {
            ...
            return app.require(["cookie"]).then(function (_ref) {
                var cookie = _ref.cookie;

                _this2.cookie = cookie;
            });
        }
    }, {
        key: "ready",
        value: function ready() {
            ...
            (0, _jquery2.default)(".sidebar").each(function () {
                var menu = (0, _jquery2.default)(this);

                _.loadState(menu);

                (0, _jquery2.default)('[data-toggle=' + _.getUniqueId(menu) + ']').on('click', function () {
                    _.toggleMenu(menu);
                });
            });
        }
        ...
        key: "getTargetWidth",
        value: function getTargetWidth(menu) {
        ...
        key: "getCssForSiblings",
        value: function getCssForSiblings(menu) {
            var key = menu.attr("data-align") === "right" ? "padding-right" : "padding-left";

            return _defineProperty({}, key, this.getTargetWidth(menu) + "px");
        }
    }, {
        key: "openMenu",
...
},{"jquery":56,"wrapper6":59}],65:[function(require,module,exports){
"use strict";
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // Vendors


var ModalModule = function (_Module) {
    _inherits(ModalModule, _Module);

    function ModalModule() {
        _classCallCheck(this, ModalModule);

        return _possibleConstructorReturn(this, (ModalModule.__proto__ || Object.getPrototypeOf(ModalModule)).apply(this, arguments));
    }

    _createClass(ModalModule, [{
        key: "alert",
        value: function alert(contents, options) {
            return (0, _alert3.default)(contents, options);
        }
        ...
        key: "confirm",
        value: function confirm(contents, options) {
            return new Promise(function (resolve, reject) {
                (0, _alert3.default)(contents, Object.assign({}, options, {
                    buttons: {
                        "Yes": function Yes(dialog) {
                            dialog.close();
                            resolve();
                        },

                        "No": function No(dialog) {
                            dialog.close();
                            reject();
                        }
                    }
        ...
        value: function ready() {
            ...
            (0, _jquery2.default)("a[data-confirm]").each(function () {
                ...
                if (typeof message === "string" && message.length > 0) {
                    target.on(event, function (e) {
                        if (confirmed === false) {
                            ...
                            return _.confirm(message).then(function () {
                                confirmed = true;
...
},{"alert.js":1,"jquery":56,"wrapper6":59}],66:[function(require,module,exports){
"use strict";
...
function createNotification(message) {
    ...
    var element = (0, _jquery2.default)("<div>").addClass("alert");
    ...
    if (typeof icon === "string") {
        (0, _jquery2.default)("<i>").addClass("material-icons").html(icon).appendTo(element);
    }

    // Message
    (0, _jquery2.default)("<span>").html(message).appendTo(element);
...
var NotificationModule = function (_Module) {
    _inherits(NotificationModule, _Module);

    function NotificationModule() {
        _classCallCheck(this, NotificationModule);

        return _possibleConstructorReturn(this, (NotificationModule.__proto__ || Object.getPrototypeOf(NotificationModule)).apply(this, arguments));
    }
    ...
    _createClass(NotificationModule, [{
        ...
        value: function boot(app) {
            // Get the container
            this.container = (0, _jquery2.default)(".notifications");

            if (this.container.length === 0) {
                this.container = (0, _jquery2.default)("<div>").addClass("notifications").appendTo((0, _jquery2.default)("body"));
            }
        }
    }, {
        key: "ready",
...
},{"jquery":56,"wrapper6":59}],67:[function(require,module,exports){
"use strict";
...
var SortableModule = function (_Module) {
    _inherits(SortableModule, _Module);

    function SortableModule() {
        _classCallCheck(this, SortableModule);

        return _possibleConstructorReturn(this, (SortableModule.__proto__ || Object.getPrototypeOf(SortableModule)).apply(this, arguments));
    }

    _createClass(SortableModule, [{
        key: "ready",
        value: function ready() {

            (0, _jquery2.default)(".content").on("click", "[data-sortable=on]", function () {
...
},{"jquery":56,"wrapper6":59}],68:[function(require,module,exports){
"use strict";
...
var CookieService = function (_Module) {
    _inherits(CookieService, _Module);

    function CookieService() {
        _classCallCheck(this, CookieService);

        return _possibleConstructorReturn(this, (CookieService.__proto__ || Object.getPrototypeOf(CookieService)).apply(this, arguments));
    }

    _createClass(CookieService, [{
        key: "set",
        value: function set(name, value) {
            var daysToExpire = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
